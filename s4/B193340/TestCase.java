package s4.B193340; // Please modify to s4.Bnnnnnn, where nnnnnn is your student ID. 
import java.lang.*;
...
public class TestCase {
	...
	try {
	    ...
	    int freq;
	    System.out.println("checking s4.B193340.Frequencer");
	    myObject = new s4.B193340.Frequencer();
	...
	try {
	    ...
	    double value;
	    System.out.println("checking s4.B193340.InformationEstimator");
	    myObject = new s4.B193340.InformationEstimator();
