...
public class Frequencer implements FrequencerInterface{
    ...
    public static void main(String[] args) {
	    ...
	    */
            ...
            frequencerObject.printSuffixArray(); // you may use this line for DEBUG
	    frequencerObject.setTarget("Hi Ho Ho Ho".getBytes());
	    System.out.println( frequencerObject.subByteStartIndex(1,2) );
	    System.out.println( frequencerObject.subByteEndIndex(1,2) );
